...
типизированное лямбда-исчисления с типами-произведениями и типами-суммами**
(в точности система, которой Вы пользовались в Теоретическом домашнем задании 3).
